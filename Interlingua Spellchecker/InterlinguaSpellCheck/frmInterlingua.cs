...
{
    public partial class frmInterlingua : Form
    {
        public bool ignoreAll = false;
        public string selectedSuggestion = string.Empty;
        public bool changeAll = false;

        public frmInterlingua()
        {
            InitializeComponent();
        }

        public frmInterlingua(string linetext, string Interlinguaword, int startposition, List<String> suggestions, bool isObject)
        {
            InitializeComponent();
            ...
            c.Font = new System.Drawing.Font("Arial", 12.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            c.Text = linetext;
            c.Find(Interlinguaword, startposition, RichTextBoxFinds.None);
            c.SelectionFont = new System.Drawing.Font("Arial", 12.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void frmInterlingua_Load(object sender, EventArgs e)
        {
